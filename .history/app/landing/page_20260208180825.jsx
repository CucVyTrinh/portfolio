          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroRoleRow}>
              ...
              <div className={styles.heroIcons}>
                <img src="/hero-icon-1.png" alt="" className={styles.heroIconImg} />
                <img src="/hero-icon-2.png" alt="" className={styles.heroIconImg} />
                <img src="/hero-icon-3.png" alt="" className={styles.heroIconImg} />
                <img src="/hero-icon-4.png" alt="" className={styles.heroIconImg} />
              </div>
            </div>
          </div>
