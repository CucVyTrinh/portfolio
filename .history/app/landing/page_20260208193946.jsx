          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroRoleRow}>
              ...
              <div className={styles.heroIcons}>
                ...
                <img src="public/landing/perfection.png" alt="Perfection" className={styles.heroIconImg} />
                <img src="public/landing/collaboration.png" alt="Collaboration" className={styles.heroIconImg} />
              </div>
            </div>
          </div>
