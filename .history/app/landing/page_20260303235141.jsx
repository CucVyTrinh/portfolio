    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <div className={styles.mainContentWrap}>
          ...
          <section
            id="about"
            ref={(el) => { aboutRef.current = el; sectionRefs.current[0] = el; }}
            className={`${styles.about} ${styles.scrollReveal}`}
          ...
          <section
            ...
            className={`${styles.projects} ${styles.scrollReveal}`}
          >
          <br />
          ...
          <div className={styles.projectList}>
            {PROJECTS.map((project, i) => {
              const cardEl = (
                <article
                  key={i}
                  ref={(el) => { if (el) sectionRefs.current[2 + i] = el; }}
                  className={`${styles.projectCard} ${styles.scrollReveal} ${
                    i % 2 === 0 ? styles.projectCardLeafOdd : styles.projectCardLeafEven
              ...
              return project.slug ? (
                <Link key={i} href={`/project/${project.slug}`} className={styles.projectCardLink}>
                  {cardEl}
                </Link>
              ) : (
                cardEl
          ...
          <div className={styles.projectsCta}>
            <div
              ref={btnWrapRef}
              className={styles.btnViewMoreWrap}
              onMouseMove={(e) => {
            ...
            >
              ...
              {HERO_ICONS.map((icon, i) => (
                <img
                  ...
                  src={icon.src}
                  alt=""
                  className={styles.btnViewMoreFlyingIcon}
                  data-direction={i}
                  aria-hidden
                />
              ))}
