          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroRoleRow}>
              ...
              <div className={styles.heroIcons}>
                <img src="/Users/trinhcucvy/Desktop/portfolio-website/app/image/empathy.png" alt="Empathy" className={styles.heroIconImg} />
                <img src="/Users/trinhcucvy/Desktop/portfolio-website/app/image/creativity.png" alt="Creative" className={styles.heroIconImg} />
                <img src="/Users/trinhcucvy/Desktop/portfolio-website/app/image/perfection.png" alt="Perfection" className={styles.heroIconImg} />
                <img src="/Users/trinhcucvy/Desktop/portfolio-website/app/image/collaboration.png" alt="Collaboration" className={styles.heroIconImg} />
              </div>
            </div>
          </div>
