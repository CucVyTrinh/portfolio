    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <div className={styles.mainContentWithBg}>
          <div className={styles.landingBgImages} aria-hidden>
            <div className={styles.landingBgImgWrap} data-img="empathy">
              <img src="/landing/empathy.png" alt="" />
            </div>
            <div className={styles.landingBgImgWrap} data-img="creativity">
              <img src="/landing/creativity.png" alt="" />
            </div>
            <div className={styles.landingBgImgWrap} data-img="perfection">
              <img src="/landing/perfection.png" alt="" />
            </div>
            <div className={styles.landingBgImgWrap} data-img="collaboration">
