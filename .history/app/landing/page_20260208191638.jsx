          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroRoleRow}>
              ...
              <div className={styles.heroIcons}>
                <img src="/image/empathy.png" alt="Empathy" className={styles.heroIconImg} />
                <img src="/image/creative.png" alt="Creative" className={styles.heroIconImg} />
                <img src="/image/perfection.png" alt="Perfection" className={styles.heroIconImg} />
                <img src="/image/collaboration.png" alt="Collaboration" className={styles.heroIconImg} />
              </div>
            </div>
          </div>
