            ...
            <div className={styles.heroRoleRow}>
              ...
              <div className={styles.heroIcons}>
                <div className={styles.heroIconWrap}>
                  ...
                  <span className={styles.heroIconTooltip} aria-hidden>empathy</span>
                </div>
                <div className={styles.heroIconWrap}>
                  <img src="/landing/creativity.png" alt="Creativity" className={styles.heroIconImg} />
                  <span className={styles.heroIconTooltip} aria-hidden>creativity</span>
                </div>
                <div className={styles.heroIconWrap}>
                  <img src="/landing/perfection.png" alt="Perfection" className={styles.heroIconImg} />
                  <span className={styles.heroIconTooltip} aria-hidden>perfection</span>
                </div>
                <div className={styles.heroIconWrap}>
                  <img src="/landing/collaboration.png" alt="Collaboration" className={styles.heroIconImg} />
                  <span className={styles.heroIconTooltip} aria-hidden>collaboration</span>
                </div>
              </div>
            </div>
          </div>
