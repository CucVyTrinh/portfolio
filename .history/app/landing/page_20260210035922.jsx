...
const SCROLL_DURATION_MS = 1400; // Slow, smooth scroll when clicking purple arrow
        ...
        <div className={styles.mainContentWrap}>
          ...
          <section id="about" className={styles.about}>
            <p className={styles.aboutText}>
              Specializing in{" "}
              <span className={styles.aboutPill}>Graphic Design</span>,{" "}
              <span className={styles.aboutPill}>UX/UI Design</span>,{" "}
              <span className={styles.aboutPill}>Front-End Development</span>, and{" "}
              <span className={styles.aboutPill}>Motion Graphic</span>.
              <br />
