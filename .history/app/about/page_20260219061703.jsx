  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Two-column grid: left = hero text + vy graphic; right = divider, intro, icons, My Joys, cloud */}
        <div className={styles.aboutContent}>
          <div className={styles.aboutGrid}>
            {/* Left column: hero text at top, vy graphic below (fills height) */}
            ...
            {/* Right column: divider, intro (yellow highlights), 4 icons, My Joys, cloud */}
            <div className={styles.aboutRight}>
              <div className={styles.aboutDivider} aria-hidden />
              <div className={styles.helloText}>
                <p className={styles.helloIntro}>
                  My name is Vy. I&apos;m a <span className={styles.helloHighlight}>digital designer</span> with front-end development skills who is constantly exploring new ideas, experimenting with visual directions, and challenging myself to step beyond what feels familiar. I enjoy experimenting with new color combinations, creative graphics, and layered details - but more importantly, I care about <span className={styles.helloHighlight}>meaning</span>. Every design decision I make is intentional. I strive to create work where visuals, interaction, and storytelling connect seamlessly to communicate something deeper than just aesthetics. The four qualities below reflect the core values that shape my work.
                </p>
              </div>
              <div
