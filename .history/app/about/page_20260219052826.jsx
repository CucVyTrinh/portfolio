...
const JOYS = [
  ...
  { id: "runmac", label: "Run Mac", size: "small" },
  { id: "fashion", label: "Fashion", size: "small" },
  { id: "travelling", label: "Travelling", size: "small" },
];

const INTRO_TEXT =
  "My name is Vy. I'm a digital designer with front-end development skills. I believe in human-centered design that balances clarity and creativity, and I care about accessibility and inclusive experiences.";
...
export default function AboutPage() {
  ...
  const initialJoyPositions = () =>
    [...JOYS, { id: "rain", label: "", size: "small" }].map((_, i) => ({
      x: i < 9 ? 12 + (i % 4) * 22 : 8,
      y: i < 9 ? 15 + Math.floor(i / 4) * 28 : 78,
    }));
      ...
      <main className={styles.main}>
        ...
        <section className={styles.hello}>
          ...
          <div className={styles.helloText}>
            <p className={styles.xinChao}>Xin Chào!</p>
            <p className={styles.helloTitle}>Hello!</p>
            <div className={styles.helloLine} aria-hidden />
            <p className={styles.helloIntro}>{INTRO_TEXT}</p>
            <div
