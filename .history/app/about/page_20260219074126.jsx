          ...
          <section className={styles.hello}>
            <div className={styles.helloLeft}>
              <div className={styles.helloGraphicWrap}>
                {/* Vy graphic (default) — position unchanged */}
                <div className={styles.vyGraphicDefault}>
                  <img
                    src="/about/vy-1.png"
                    alt="Vy waving"
                ...
                {/* Hover flip overlay: vy-young + vy-old */}
                <div className={styles.vyFlipOverlay}>
                  <div className={styles.vyFlipInner}>
                    <img
                      src="/about/vy-old.jpg"
                      alt="Vy"
                      className={styles.vyOldImg}
                    />
                    <img
                      src="/about/vy-young.jpg"
                      alt="Vy young"
                      className={styles.vyYoungImg}
                    />
                  </div>
                </div>
              </div>
