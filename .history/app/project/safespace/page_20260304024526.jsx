    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          {/* Seamless recording & Posting flow - Finding / Solution + finding-1 */}
          <div className={`${styles.userTestingFlowSection} ${styles.scrollReveal}`} ref={setRef(22)}>
            <h4 className={styles.userTestingFlowTitle}>Seamless recording & Posting flow</h4>
            <div className={styles.userTestingFlowTwoCol}>
              <div className={styles.userTestingFlowCol}>
                ...
                <ul className={styles.userTestingFlowList}>
                  <li>Users were unsure about the difference between recording and creating a report.</li>
                  <li>&ldquo;Reports&rdquo; in the navigation felt similar to recording.</li>
                  <li>The flow between capturing evidence and posting publicly felt disconnected.</li>
                </ul>
              </div>
              <div className={styles.userTestingFlowCol}>
                <h5 className={styles.userTestingFlowColTitle}>Solution</h5>
                <ul className={styles.userTestingFlowList}>
                  <li>Renamed &ldquo;Reports&rdquo; → &ldquo;Posts&rdquo; in the navigation to clarify public content.</li>
                  <li>Introduced a clearly defined center Record action as the primary CTA.</li>
                  <li>Elevated the home screen with a prominent map and clearer content hierarchy.</li>
                </ul>
              </div>
            </div>
            <div className={styles.userTestingFlowImgWrap}>
              <Image
                src={`${IMG}/finding-1.png`}
                alt="Recording and posting flow before and after"
                width={1200}
                height={600}
