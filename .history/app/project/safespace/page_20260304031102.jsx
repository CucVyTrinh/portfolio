    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.wireframesText} ${styles.scrollReveal}`} ref={setRef(27)}>
            <p className={styles.bodyText}>
              Promotional and outreach materials created to communicate SafeSpace&apos;s mission and reach women and gender-diverse tradespeople, unions, and industry partners.
            </p>
          </div>
          <div className={`${styles.marketingMaterialsGrid} ${styles.scrollReveal}`} ref={setRef(28)}>
            {/* Add marketing images here, e.g. posters, social cards, brochures */}
            <div className={styles.marketingMaterialsPlaceholder}>
              <p className={styles.marketingMaterialsPlaceholderText}>Marketing materials coming soon</p>
            </div>
          </div>
        </section>
