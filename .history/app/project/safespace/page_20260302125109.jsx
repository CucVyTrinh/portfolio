...
const TAG_CLOUD_PHRASES = [
  { text: 'Fear of being labeled "difficult" or "overreacting"', size: "small" },
  { text: "Backlash or retaliation", size: "medium" },
  { text: "Lack of evidence", size: "large" },
  { text: "Fear of disbelief", size: "large" },
  { text: "Workplace cultures that normalize inappropriate behavior", size: "medium" },
  { text: "Reporting feels intimidating", size: "large" },
  { text: "Overwhelming reporting forms", size: "medium" },
  { text: "Supervisors seem unapproachable", size: "medium" },
];

const TAG_COLORS = ["#EAFFA6", "#a855f7", "#3B82F6"];
    ...
    <div className={styles.page}>
      ...
      <main>
          ...
          <div className={styles.tagCloudSection}>
            ...
            <div className={styles.tagCloud}>
              {TAG_CLOUD_PHRASES.map((item, i) => (
                <span
                  key={item.text}
                  className={`${styles.tagCloudTag} ${styles[`tagSize${item.size.charAt(0).toUpperCase() + item.size.slice(1)}`]}`}
                  style={{ "--tag-color": TAG_COLORS[i % TAG_COLORS.length], "--tag-delay": `${i * 0.4}s`, "--tag-dur": `${4 + (i % 3)}s` }}
                >
                  {item.text}
                </span>
              ))}
        ...
        <section className={styles.section} id="introduction">
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(3)}>
            Introduction
          </h2>
          <p className={`${styles.bodyText} ${styles.scrollReveal}`} ref={setRef(4)}>
          ...
          <div className={`${styles.challengeSolutionBox} ${styles.scrollReveal}`} ref={setRef(5)}>
        ...
        <section className={styles.section}>
          <div className={styles.uiFeatureRow}>
            <div className={`${styles.uiMockupWrap} ${styles.scrollReveal}`} ref={setRef(6)}>
            ...
            <div className={styles.featureCol}>
              <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(7)}>
                Empathy
              </h3>
              <p className={`${styles.bodyText} ${styles.scrollReveal}`} ref={setRef(8)}>
              ...
              <h4 className={`${styles.keyFeaturesTitle} ${styles.scrollReveal}`} ref={setRef(9)}>
                Key Features
              </h4>
        ...
        <section className={styles.section}>
          ...
          <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(13)}>
            Empathy Map
          </h3>
          <div className={styles.empathyCards}>
            <div className={`${styles.empathyCard} ${styles.empathyCardOrange} ${styles.scrollReveal}`} ref={setRef(14)}>
              <Image
            ...
            <div className={`${styles.empathyCard} ${styles.empathyCardBlue} ${styles.scrollReveal}`} ref={setRef(15)}>
              <Image
        ...
        {/* User Flow */}
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(16)}>
            User Flow
          </h2>
          <div className={`${styles.flowDiagramWrap} ${styles.scrollReveal}`} ref={setRef(17)}>
            <Image
        ...
        <section className={styles.section}>
          ...
          <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(19)}>
            Brainstorming
          </h3>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(32)}>
            Brand Identity
          </h2>

          <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(33)}>
            Colors
          </h3>
          <div className={`${styles.colorRow} ${styles.scrollReveal}`} ref={setRef(34)}>
            <Image
          ...
          <div className={`${styles.gradientRow} ${styles.scrollReveal}`} ref={setRef(36)}>
          ...
          <div className={`${styles.logosRow} ${styles.scrollReveal}`} ref={setRef(38)}>
