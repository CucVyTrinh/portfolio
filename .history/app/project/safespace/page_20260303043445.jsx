            ...
            <div className={`${styles.brandingTwoCol} ${styles.typographyGrid}`}>
              <div>
                ...
                <div className={styles.logoInCol}>
                  ...
                  <Image src={`${IMG}/logo.png`} alt="SafeSpace logo" width={400} height={400} className={styles.logoInColImg} unoptimized />
                  <Image src={`${IMG}/logo-text.png`} alt="SafeSpace logo with text" width={600} height={200} className={styles.logoInColImg} unoptimized />
                </div>
              </div>
