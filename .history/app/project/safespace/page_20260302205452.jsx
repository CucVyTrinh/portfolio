    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          {/* Color Palette */}
          <div className={`${styles.brandingSection} ${styles.scrollReveal}`} ref={setRef(18)}>
            <h4 className={styles.diagramLabel}>Color Palette</h4>
            <div className={styles.brandingTwoCol}>
              <div className={styles.brandingColLeft}>
                <div className={styles.wireframesExpandRow}>
                  <button
                    type="button"
                    className={styles.diagramExpandBtn}
                  ...
                  >
                    <Image src={`${IMG}/click-to-expand.png`} alt="" width={804} height={188} className={styles.personaExpandBtnImgDefault} unoptimized />
                    <Image src={`${IMG}/click-to-expand-clicked.png`} alt="" width={804} height={188} className={styles.personaExpandBtnImgHover} unoptimized />
                  </button>
                </div>
                <button type="button" className={styles.diagramImgBtn} onClick={() => setDiagramExpanded("colorpalette")} aria-label="Expand color palette">
                  <Image src={`${IMG}/color-palette.png`} alt="SafeSpace color palette" width={800} height={400} className={styles.diagramImg} unoptimized />
                </button>
              </div>
              <p className={styles.bodyText}>
          ...
          <div className={`${styles.brandingSection} ${styles.scrollReveal}`} ref={setRef(19)}>
            ...
            <div className={styles.brandingTwoCol}>
              ...
              <div className={styles.brandingColRight}>
                <div className={styles.brandingExpandRow}>
                  <button
                    type="button"
                    className={styles.diagramExpandBtn}
                ...
                <button type="button" className={styles.diagramImgBtn} onClick={() => setDiagramExpanded("typography")} aria-label="Expand typography">
                  <Image src={`${IMG}/typo.png`} alt="SafeSpace typography" width={800} height={500} className={styles.diagramImg} unoptimized />
                </button>
              </div>
            </div>
          </div>
