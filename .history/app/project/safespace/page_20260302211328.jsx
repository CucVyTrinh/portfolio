          ...
          <div className={`${styles.brandingSection} ${styles.typographySection} ${styles.scrollReveal}`} ref={setRef(19)}>
            ...
            <div className={styles.brandingTwoCol}>
              ...
              <div className={styles.brandingColRight}>
                <button type="button" className={`${styles.diagramImgBtn} ${styles.typographyImgBtn}`} onClick={() => setDiagramExpanded("typography")} aria-label="Expand typography">
                  <Image src={`${IMG}/typo.png`} alt="SafeSpace typography" width={1100} height={688} className={styles.diagramImg} unoptimized />
                </button>
              </div>
            </div>
          </div>
