      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.block}>
            <p className={`${styles.bodyTextColumn} ${styles.scrollReveal}`} ref={setRef(6)}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.empathyCards}>
            <div className={`${styles.empathyCard} ${styles.empathyCardOrange} ${styles.scrollReveal}`} ref={setRef(20)}>
              <Image
            ...
            <div className={`${styles.empathyCard} ${styles.empathyCardBlue} ${styles.scrollReveal}`} ref={setRef(21)}>
              <Image
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.flowDiagramWrap} ${styles.scrollReveal}`} ref={setRef(23)}>
            <Image
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(24)}>
            Ideation
          </h2>
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(25)}>
            Brainstorming
          </h3>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(38)}>
            Brand Identity
          </h2>
          ...
          <div className={`${styles.colorRow} ${styles.scrollReveal}`} ref={setRef(40)}>
            <Image
          ...
          <div className={`${styles.gradientRow} ${styles.scrollReveal}`} ref={setRef(42)}>
            ...
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(43)}>
            Logos & Icons
          </h3>
          <div className={`${styles.logosRow} ${styles.scrollReveal}`} ref={setRef(44)}>
