    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.sectionTitlePurple} ${styles.scrollReveal}`} ref={setRef(5)}>
            User Personas
          </h2>
        ...
        <section className={styles.section} id="introduction">
          ...
          <div className={`${styles.challengeSolutionBox} ${styles.scrollReveal}`} ref={setRef(9)}>
        ...
        <section className={styles.section}>
          <div className={styles.uiFeatureRow}>
            <div className={`${styles.uiMockupWrap} ${styles.scrollReveal}`} ref={setRef(10)}>
            ...
            <div className={styles.featureCol}>
              <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(11)}>
                Empathy
              </h3>
              <p className={`${styles.bodyText} ${styles.scrollReveal}`} ref={setRef(12)}>
              ...
              <h4 className={`${styles.keyFeaturesTitle} ${styles.scrollReveal}`} ref={setRef(13)}>
                Key Features
              </h4>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(16)}>
            ...
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(17)}>
            Empathy Map
          </h3>
          <div className={styles.empathyCards}>
            <div className={`${styles.empathyCard} ${styles.empathyCardOrange} ${styles.scrollReveal}`} ref={setRef(18)}>
              <h4 className={styles.sectionSubtitle}>Primary Persona</h4>
              <Image
            ...
            <div className={`${styles.empathyCard} ${styles.empathyCardBlue} ${styles.scrollReveal}`} ref={setRef(19)}>
              <h4 className={styles.sectionSubtitle}>Secondary Persona</h4>
              <Image
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.flowDiagramWrap} ${styles.scrollReveal}`} ref={setRef(21)}>
            <Image
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(22)}>
            Ideation
          </h2>
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(23)}>
            Brainstorming
          </h3>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(36)}>
            Brand Identity
          </h2>
          ...
          <div className={`${styles.colorRow} ${styles.scrollReveal}`} ref={setRef(38)}>
            <Image
          ...
          <div className={`${styles.gradientRow} ${styles.scrollReveal}`} ref={setRef(40)}>
            ...
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(41)}>
            Logos & Icons
          </h3>
          <div className={`${styles.logosRow} ${styles.scrollReveal}`} ref={setRef(42)}>
