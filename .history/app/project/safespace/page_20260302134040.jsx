    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section} id="introduction">
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(4)}>
            Introduction
          </h2>
          <p className={`${styles.bodyText} ${styles.scrollReveal}`} ref={setRef(5)}>
          ...
          <div className={`${styles.challengeSolutionBox} ${styles.scrollReveal}`} ref={setRef(6)}>
        ...
        <section className={styles.section}>
          <div className={styles.uiFeatureRow}>
            <div className={`${styles.uiMockupWrap} ${styles.scrollReveal}`} ref={setRef(7)}>
            ...
            <div className={styles.featureCol}>
              <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(8)}>
                Empathy
              </h3>
              ...
              <h4 className={`${styles.keyFeaturesTitle} ${styles.scrollReveal}`} ref={setRef(10)}>
                Key Features
              </h4>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(13)}>
            User Research
          </h2>
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(14)}>
            Empathy Map
          </h3>
          <div className={styles.empathyCards}>
            <div className={`${styles.empathyCard} ${styles.empathyCardOrange} ${styles.scrollReveal}`} ref={setRef(15)}>
              <Image
            ...
            <div className={`${styles.empathyCard} ${styles.empathyCardBlue} ${styles.scrollReveal}`} ref={setRef(16)}>
              <Image
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.flowDiagramWrap} ${styles.scrollReveal}`} ref={setRef(18)}>
            <Image
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(19)}>
            Ideation
          </h2>
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(20)}>
            Brainstorming
          </h3>
        ...
        <section className={styles.section}>
          <h2 className={`${styles.sectionTitle} ${styles.scrollReveal}`} ref={setRef(33)}>
            Brand Identity
          </h2>
          ...
          <div className={`${styles.colorRow} ${styles.scrollReveal}`} ref={setRef(35)}>
            <Image
          ...
          <div className={`${styles.gradientRow} ${styles.scrollReveal}`} ref={setRef(37)}>
            ...
            <h3 className={`${styles.subHeading} ${styles.scrollReveal}`} ref={setRef(38)}>
            Logos & Icons
          </h3>
          <div className={`${styles.logosRow} ${styles.scrollReveal}`} ref={setRef(39)}>
