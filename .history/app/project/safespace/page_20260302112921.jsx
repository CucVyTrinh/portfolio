...
const PROJECT_DETAILS = {
  ...
  tools: [
    "Figma",
    "Adobe Suite (Photoshop, Illustrator, InDesign, After Effects, Premiere)",
    "React Native (Expo), TypeScript, React, Next.js, JavaScript",
  ],
  duration: "Sep - Dec 2025 · 4 months · Team of 8",
};
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroTwoCol}>
            <div className={`${styles.heroBlock} ${styles.scrollReveal}`} ref={setRef(0)}>
              ...
              <Link href="#introduction" className={styles.overviewButton}>
                Read the case study
              </Link>
            </div>
