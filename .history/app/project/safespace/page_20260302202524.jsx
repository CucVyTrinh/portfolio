    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.diagramCard} ${styles.wireframesDiagramCard} ${styles.scrollReveal}`} ref={setRef(14)}>
            ...
            <div className={`${styles.wireframesText} ${styles.scrollReveal}`} ref={setRef(15)}>
              <p className={styles.bodyText}>
