      ...
      <main>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.diagramCards}>
            <div className={`${styles.diagramCard} ${styles.scrollReveal}`} ref={setRef(11)}>
              ...
              <p className={styles.diagramLabel}>Sitemap</p>
            </div>
            <div className={`${styles.diagramCard} ${styles.scrollReveal}`} ref={setRef(12)}>
              ...
              <p className={styles.diagramLabel}>User Flow</p>
            </div>
          </div>
        </section>
        ...
        {diagramExpanded != null && (
          ...
          >
            ...
            <Image
              src={diagramExpanded === "sitemap" ? `${IMG}/sitemap.jpg` : `${IMG}/userflow.jpg`}
              alt={diagramExpanded === "sitemap" ? "SafeSpace sitemap" : "SafeSpace user flow"}
              width={1400}
              height={1000}
              className={styles.personaOverlayImg}
              onClick={(e) => e.stopPropagation()}
