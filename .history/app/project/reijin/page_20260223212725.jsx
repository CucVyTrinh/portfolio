  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Rationale (left) | Info card + icons (right) */}
            ...
            <div className={styles.rightColumn}>
              ...
              >
                ...
                <div className={styles.rationaleIcons}>
                  <img src={`${IMG}/blue.png`} alt="Water" className={styles.circularImg} />
                  <img src={`${IMG}/red.png`} alt="Fire" className={styles.circularImg} />
                  <img src={`${IMG}/white.png`} alt="Metal" className={styles.circularImg} />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className={styles.section}>
          <div
            className={`${styles.overviewBlock} ${styles.scrollReveal}`}
