...
const RATIONALE_PARAGRAPH_1 = "My starting point for this project was a personal fascination with Japanese swords and samurai culture.";
const RATIONALE_PARAGRAPH_2 = (
  <>
  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Two-column layout: Overview + Rationale+icons (left, with black bar) | Role, Tools, etc. (right) */}
        <section className={styles.section}>
          <div className={styles.twoColumnLayout}>
            <div className={styles.leftColumn}>
              <div className={styles.leftColumnWithBar}>
                <div className={styles.blackBar} aria-hidden />
                <div
                ...
                <div
                  className={`${styles.rationaleRow} ${styles.scrollReveal}`}
                  ref={(el) => (partRefs.current[1] = el)}
                >
                  <div className={styles.blockRationale}>
                    ...
                    <p className={styles.bodyTextColumn}>{RATIONALE_PARAGRAPH_1}</p>
                    <p className={styles.bodyTextColumn}>{RATIONALE_PARAGRAPH_2}</p>
                  </div>
                  <div className={styles.blockCircular}>
