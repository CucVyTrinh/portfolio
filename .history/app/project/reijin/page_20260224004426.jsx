...
export default function ReijinProjectPage() {
  ...
  const [viewDesignHover, setViewDesignHover] = useState({
    active: null,
    x: 0,
    y: 0,
  });
  const viewDesignWrapRefs = useRef([null, null, null]);
  const mockupImages = [
    `${IMG}/mockup-1.jpg`,
    `${IMG}/mockup-2.jpg`,
    `${IMG}/mockup-3.jpg`,
          ...
          <div className={styles.mockupSection}>
            ...
            >
              <div className={styles.mockup3DItem}>
                <div
                  ref={(el) => (viewDesignWrapRefs.current[0] = el)}
                  className={styles.viewDesignBtnWrap}
                  style={
                    viewDesignHover.active === 0
                      ? {
                          "--mouse-x": `${viewDesignHover.x}px`,
                          "--mouse-y": `${viewDesignHover.y}px`,
                        }
                      : undefined
                  }
                  onMouseMove={(e) => {
                    const el = viewDesignWrapRefs.current[0];
                    if (!el) return;
                  ...
                  onMouseLeave={() =>
                    setViewDesignHover((prev) =>
                      prev.active === 0 ? { active: null, x: 0, y: 0 } : prev
                    )
                  }
                >
                  <button
                  ...
                  {VIEW_DESIGN_ICONS.map((icon, i) => (
                    <img
                      key={icon.label}
                      src={icon.src}
                      alt=""
                      className={styles.viewDesignBtnFlyingIcon}
                      data-direction={i}
                      aria-hidden
                    />
                  ))}
              ...
              <div className={styles.mockup3DItem}>
                <div
                  ref={(el) => (viewDesignWrapRefs.current[1] = el)}
                  className={styles.viewDesignBtnWrap}
                  style={
                    viewDesignHover.active === 1
                      ? {
                          "--mouse-x": `${viewDesignHover.x}px`,
                          "--mouse-y": `${viewDesignHover.y}px`,
                        }
                  ...
                  onMouseMove={(e) => {
                    const el = viewDesignWrapRefs.current[1];
                    if (!el) return;
                    const rect = el.getBoundingClientRect();
                    setViewDesignHover({
                      active: 1,
                  ...
                  onMouseLeave={() =>
                    setViewDesignHover((prev) =>
                      prev.active === 1 ? { active: null, x: 0, y: 0 } : prev
                    )
                  }
                >
                  <button
              ...
              <div className={styles.mockup3DItem}>
                <div
                  ref={(el) => (viewDesignWrapRefs.current[2] = el)}
                  className={styles.viewDesignBtnWrap}
                  style={
                    viewDesignHover.active === 2
                      ? {
                          "--mouse-x": `${viewDesignHover.x}px`,
                          "--mouse-y": `${viewDesignHover.y}px`,
                        }
                  ...
                  onMouseMove={(e) => {
                    const el = viewDesignWrapRefs.current[2];
                    if (!el) return;
                    const rect = el.getBoundingClientRect();
                    setViewDesignHover({
                      active: 2,
                  ...
                  onMouseLeave={() =>
                    setViewDesignHover((prev) =>
                      prev.active === 2 ? { active: null, x: 0, y: 0 } : prev
                    )
                  }
                >
                  <button
