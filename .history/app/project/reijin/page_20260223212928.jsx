  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Overview + Rationale (left) | Info card + icons (right) */}
        <section className={styles.section}>
          <div className={`${styles.rationaleBlock} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[0] = el)}>
            <div className={styles.twoColumnLayout}>
              ...
              <div className={styles.rightColumn}>
                ...
                <div className={styles.rationaleIcons}>
                  <img src={`${IMG}/water.png`} alt="Water" className={styles.circularImg} />
                  <img src={`${IMG}/fire.png`} alt="Fire" className={styles.circularImg} />
                  <img src={`${IMG}/metal.png`} alt="Metal" className={styles.circularImg} />
                </div>
              </div>
            </div>
            <div className={styles.rationaleBar} aria-hidden />
          </div>
        </section>

        {/* Visual Storytelling: paragraph (left) | three-color.png (right) */}
        <section className={styles.section}>
          <div
          ...
          >
            <div className={styles.visualStoryRow}>
              ...
              <div className={styles.visualStoryImg}>
                <img src={`${IMG}/three-color.png`} alt="" className={styles.threeColorImg} />
              </div>
            </div>
          </div>
        </section>
