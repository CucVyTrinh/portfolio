  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Hero: title + subtitle + three posters */}
        <section className={styles.hero}>
          <div className={styles.heroTop}>
            <h1 className={styles.heroTitle}>Reijin</h1>
            <p className={styles.heroSubtitle}>Collection of three posters</p>
          </div>
          <div className={styles.heroPosters}>
            <img
              src={`${IMG}/poster-2.jpg`}
              alt="Reijin poster — blue celestial"
              className={styles.heroPoster}
            />
            <img
              src={`${IMG}/poster-3.jpg`}
              alt="Reijin poster — red dynamic"
              className={styles.heroPoster}
            />
            <img
              src={`${IMG}/header.jpg`}
              alt="Reijin poster — balanced"
              className={styles.heroPoster}
            />
          </div>
        </section>
        ...
        <section className={styles.section}>
          <div className={styles.twoColumnLayout}>
            <div className={styles.leftColumn}>
              ...
              >
                <h3 className={styles.sectionSubtitle}>Rationale</h3>
            ...
            <div className={styles.rightColumn}>
              ...
              >
                <ProjectInfoCard
                  role="Graphic Design / Branding Design"
        ...
        {/* Mockups: 3D object below the heading */}
