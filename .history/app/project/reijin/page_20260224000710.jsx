...
const DisplayStands3DRow = dynamic(
  () => import("../../components/DisplayStand3D").then((m) => ({ default: m.DisplayStands3DRow })),
  { ssr: false }
);
      ...
      <main>
        ...
        <section className={styles.section} id="mockups">
          <div className={styles.mockupSection}>
            ...
            >
              <div className={styles.mockup3DLabelsRow}>
                <span className={styles.mockup3DLabel}>Water</span>
                <span className={styles.mockup3DLabel}>Fire</span>
                <span className={styles.mockup3DLabel}>Metal</span>
              </div>
              <div className={styles.mockup3DCanvasWrap}>
                <DisplayStands3DRow />
              </div>
            </div>
            <div
