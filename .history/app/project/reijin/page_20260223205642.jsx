  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Two-column layout: Overview (left) | Role, Tools, Rationale+icons (full width), Visual Storytelling (right) */}
        <section className={styles.section}>
          <div className={styles.twoColumnLayout}>
            ...
            >
              <div className={styles.rationaleRect} aria-hidden />
              <div className={styles.rationaleContent}>
                <div className={styles.rationaleLeft}>
                  ...
                  <p className={styles.bodyTextColumn}>{RATIONALE_PARAGRAPH}</p>
                </div>
                <div className={styles.rationaleRight}>
                  <img src={`${IMG}/red.png`} alt="" className={styles.rationaleIcon} />
                  <img src={`${IMG}/blue.png`} alt="" className={styles.rationaleIcon} />
                  <img src={`${IMG}/white.png`} alt="" className={styles.rationaleIcon} />
                </div>
              </div>
            </div>
