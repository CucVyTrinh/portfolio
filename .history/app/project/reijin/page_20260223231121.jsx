  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Visual Storytelling: three icon sets (left) | title + paragraph (right) */}
        <section className={styles.section}>
          <div
          ...
          >
            <div className={styles.visualStoryRow}>
              <div className={styles.visualStoryIcons}>
                <div className={styles.iconSet}>
                  <img src={`${IMG}/water.png`} alt="Water" className={styles.visualStorySymbol} />
                  <div className={styles.iconSetCircles}>
                    <span className={`${styles.circleDot} ${styles.circleBlue}`} aria-hidden />
                    <span className={`${styles.circleDot} ${styles.circleRed}`} aria-hidden />
                  </div>
                </div>
                <div className={styles.iconSet}>
                  <img src={`${IMG}/fire.png`} alt="Fire" className={styles.visualStorySymbol} />
                  <div className={styles.iconSetCircles}>
                    <span className={`${styles.circleDot} ${styles.circleRed}`} aria-hidden />
                    <span className={`${styles.circleDot} ${styles.circleGrey}`} aria-hidden />
                  </div>
                </div>
                <div className={styles.iconSet}>
                  <img src={`${IMG}/metal.png`} alt="Metal" className={styles.visualStorySymbol} />
                  <div className={styles.iconSetCircles}>
                    <span className={`${styles.circleDot} ${styles.circleBlue}`} aria-hidden />
                    <span className={`${styles.circleDot} ${styles.circleGrey}`} aria-hidden />
                  </div>
