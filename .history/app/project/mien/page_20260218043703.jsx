  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Two-column layout: left = Overview, Miên title, Graphic Elements; right = Info box, Rationale, civets, Color Palette */}
        <section className={styles.section}>
          <div className={styles.twoColumnLayout}>
            <div className={styles.leftColumn}>
              ...
              <div className={styles.block}>
                <h2 className={styles.sectionTitle}>Graphic Elements</h2>
            ...
            <div className={styles.rightColumn}>
              ...
              <div className={styles.block}>
                <h3 className={styles.rationaleHeading}>Color Palette</h3>
