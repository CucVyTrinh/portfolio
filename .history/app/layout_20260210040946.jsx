    ...
    <html lang="en">
      ...
      >
        <div className="pageWrap">
          ...
          <div className="contentBgImages" aria-hidden>
            <span className="contentBgImg" data-img="empathy" />
            <span className="contentBgImg" data-img="creativity" />
            <span className="contentBgImg" data-img="perfection" />
            <span className="contentBgImg" data-img="collaboration" />
          </div>
