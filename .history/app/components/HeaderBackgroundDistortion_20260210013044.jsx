...
export default function HeaderBackgroundDistortion({
  ...
  useEffect(() => {
    ...
    /* Throttle: capture during scroll every ~100ms so content under header updates quickly. */
    const CAPTURE_THROTTLE_MS = 100;
    const CAPTURE_SCALE = 0.55;
    ...
    /* Throttled capture: run capture during scroll so content under header updates immediately. */
    ...
    const initialTimer = setTimeout(scheduleCapture, 150);
