...
export default function HeaderBackgroundDistortion({
  ...
  useEffect(() => {
    ...
    /* Throttle scroll: capture every ~50ms while scrolling for fast, smooth updates. */
    const CAPTURE_THROTTLE_MS = 50;
    const CAPTURE_SCALE = 0.5; /* Slightly lower for faster html2canvas */
