    ...
    <footer className={styles.footer}>
      <div className={styles.footerInner}>
        <div className={styles.footerCol}>
          <a href="mailto:cucvy.trinh@gmail.com">Email</a>
          <a href="https://linkedin.com/in/cucvytrinh" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          <a href="#">Resume</a>
        </div>
        <div className={styles.footerColCenter}>
          ...
          >
            <a href="mailto:cucvy.trinh@gmail.com" className={styles.btnGetInTouch}>
              Get in Touch
            </a>
