  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        {/* Two-column layout: each part reveals on scroll */}
        <section className={styles.section}>
          <div className={styles.twoColumnLayout}>
            <div className={styles.leftColumn}>
              <div className={`${styles.block} ${styles.overviewBlock} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[0] = el)}>
                <h2 className={styles.sectionTitle}>Overview</h2>
                <p className={styles.bodyTextOverview}>{OVERVIEW_TEXT}</p>
              </div>
              <div className={`${styles.block} ${styles.blockTitleImg} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[1] = el)}>
                <img
                  src={`${IMG}/title.png`}
                  alt="Miên"
              ...
              <div className={`${styles.block} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[2] = el)}>
                <h3 className={styles.sectionSubtitle}>Graphic Elements</h3>
                <p className={styles.bodyTextColumn}>{GRAPHIC_ELEMENTS_TEXT}</p>
              </div>
              <div className={`${styles.block} ${styles.blockColorBars} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[3] = el)}>
            ...
            <div className={styles.rightColumn}>
              ...
              <div className={`${styles.block} ${styles.blockRationale} ${styles.rationaleBlock} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[5] = el)}>
              ...
              <div className={`${styles.block} ${styles.blockCivets} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[6] = el)}>
              ...
              <div className={`${styles.block} ${styles.blockColorPalette} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[7] = el)}>
        ...
        <section className={styles.section}>
          <div className={styles.dielineSection}>
            <div className={`${styles.dielineHeader} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[8] = el)}>
            ...
            <div className={`${styles.mockups} ${styles.scrollReveal}`} ref={(el) => (partRefs.current[9] = el)}>
